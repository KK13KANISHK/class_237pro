...
saved_model_file = open('classifier_model.plk', 'rb')
    ...
    def _Radar_callback(radar_data):
        ...
        for detection in radar_data:
            ...
            if prediction == 1:
                ...
                dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.5))
                time.sleep(10)
                printprint("Your model took decision to go left since the prediction is 1")
                break
                ...
                dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.5))
                time.sleep(10)
                print("Your model took decision to go Right since the prediction is 1")
                break
